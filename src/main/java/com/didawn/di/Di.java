...
public class Di {
    ...
    private static final String BASE_WWW_URL = HTTP_WWW + dawnDotCom() + "/";
    ...
    public Di() {
        get(BASE_WWW_URL, Arrays.asList(browserHeaders));
    }
    ...
    public static String post(String url, String data, List<Header> headers) {
        ...
        if (responseContent != null && responseContent.contains("VALID_TOKEN_REQUIRED")) {
            get(BASE_WWW_URL, asList(browserHeaders));
    ...
    public Song getSong(String songID) {
        String trackResponse = post(
                BASE_WWW_URL + "ajax/gw-light.php?api_version=1.0&api_token=" + apiToken + "&input=3",
    ...
    private Map<String, Song> getExtraInfo(Map<String, Song> songList) {
        ...
        String url = BASE_WWW_URL + "ajax/gw-light.php?api_version=1.0&api_token=" + apiToken + "&input=3&cid=" + randomAlphanumeric(18).
                toLowerCase();
        String trackResponse = post(url, ids, asList(browserHeaders));
